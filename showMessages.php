    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <legend>
                ...
                <h3 class="wedding">Show a Email Response</h3>
            </legend>
            <?php
                ...
                <form class="form-horizontal" action="process_editHoneymoon.php" method="POST">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-9">
                            <input name="name" type="text" class="form-control" value="<?php echo $email['name']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-9">
                            <textarea name="message" rows="6" class="form-control col-lg-12 col-md-12 col-sm-12"><?php echo $email['message']; ?></textarea>
                        </div>
                    </div>
